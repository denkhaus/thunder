...
// convertVersionedSchemas takes multiple service schemas,
// generate a single schema, and annotates the schema with
// the federation info (the mapping from field to service)
